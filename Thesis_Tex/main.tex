...
\begin{table}[htbp]
    ...
    \begin{tabular}{lrrrr}
        ...
        \hspace{1em}Average Score & 0.376 & 0.096 & 0.018 & 0.084 \\
        \hspace{1em}Average Score (Stat. Mod.) & 0.253 & 0.144 & 0.024 & 0.062 \\
        \hspace{1em}Average Score (NN) & 0.472 & 0.059 & 0.014 & 0.108 \\
        ...
        \hspace{1em}Average Score & 0.832 & 0.586 & 0.554 & 0.615 \\
        \hspace{1em}Average Score (Stat. Mod.) & 0.887 & 0.572 & 0.634 & 0.613 \\
        \hspace{1em}Average Score (NN) & 0.767 & 0.604 & 0.506 & 0.659 \\
