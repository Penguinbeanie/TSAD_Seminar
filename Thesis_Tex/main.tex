...
A sizable portion of all anomalies found in the NAB dataset fit into the category of \textbf{trivial anomalies} and can be detected using simple thresholding functions. Examples of that can be found in Figure 1 \ref{fig:trivial}. \par
